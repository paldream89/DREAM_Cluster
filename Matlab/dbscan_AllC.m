...
% This program does consider all categories

addpath ..  %add path for OpenMolList/WriteMolBinNXcYcZc

MinPts = 43; % If the density is higher than 10/(0.2^2), add into cluster. Otherwise define this as the edge.
eps =0.2;
...
outfile=sprintf('%s_db_eps%4.2f_MP%d.bin',filehead,eps,MinPts);
